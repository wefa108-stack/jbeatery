...
export default function AboutPage() {
  return (
    <main className="bg-[#14100e] text-[#ede8e5] w-full min-h-screen flex flex-col items-center px-6 pt-36 pb-20 relative z-10">
      ...
      <h1 className="text-[#ede8e5] font-serif font-light text-3xl md:text-5xl uppercase tracking-[0.2em] text-center mb-12">
        About JBE
      </h1>
      <div className="max-w-2xl w-full text-center font-serif text-lg md:text-2xl text-[#ede8e5]/90 leading-[2.1] space-y-8">
        <p>
        ...
        <div className="pt-8 font-serif text-base md:text-xl text-[#c9a47c] tracking-[0.1em] space-y-2 opacity-95">
