      ...
      <div className="relative z-10 w-full bg-[#f8f2e9] text-[#231916]">
        ...
        <main id="about-section" className="relative z-10 w-full flex flex-col items-center pt-20 pb-20 md:pt-36 md:pb-32">
          <section className="flex flex-col justify-center items-center w-full px-6 md:px-12 max-w-2xl mx-auto text-center gap-8 md:gap-10">
            ...
            <div className="space-y-3 flex flex-col items-center mb-6 md:mb-12">
              <h2 className="font-huiwen text-[#231916] font-normal text-3xl md:text-5xl uppercase tracking-[0.2em] leading-tight">
                About JBE
              </h2>
            </div>

            {/* Copy Paragraphs - Huiwen Mingcho Font (.font-huiwen) Left-aligned */}
            <div className="font-huiwen font-normal text-lg md:text-2xl text-[#3b2e28] leading-normal md:leading-[1.6] tracking-[0.02em] text-left space-y-6 md:space-y-8 max-w-xl md:max-w-2xl w-full">
              <p>
            ...
            {/* Sign-off - Huiwen Mingcho Font (.font-huiwen) Indented Right */}
            <div className="pt-6 md:pt-8 font-huiwen text-lg md:text-xl text-[#3b2e28] tracking-[0.12em] space-y-2 ml-auto w-fit text-left pr-8 sm:pr-16 md:pr-24">
