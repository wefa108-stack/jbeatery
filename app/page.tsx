...
export default function Home() {
  return (
    <div className="relative w-full min-h-screen bg-[#f3ece6] text-[#231916] overflow-hidden">
      {/* Seamless Continuous Background for Whole Page */}
      <div
        className="fixed inset-0 w-full h-full pointer-events-none bg-cover bg-center z-0"
        style={{ backgroundImage: "url('/jbe_plain_beige_bg.png')" }}
      />
      ...
      {/* About Section - Soft Organic Transition */}
      <main id="about-section" className="relative z-10 w-full flex flex-col items-center pt-8 pb-20 md:pt-12 md:pb-28">
        <section className="flex flex-col justify-center items-center w-full px-6 md:px-12 max-w-3xl mx-auto text-center gap-12">
          ...
          <div className="space-y-3 flex flex-col items-center">
            <span className="font-mono text-[10px] md:text-[11px] uppercase tracking-[0.3em] text-[#8c674b]/90">
              Welcome to
            </span>
            <h2 className="text-[#231916] font-serif font-light text-3xl md:text-5xl uppercase tracking-[0.2em] leading-tight">
              About JBE
            </h2>
            <div className="w-10 h-[1px] bg-[#8c674b]/30 mt-1" />
          </div>
          ...
          {/* Sign-off */}
          <div className="pt-6 md:pt-10 font-serif text-base md:text-xl text-[#8c674b] tracking-[0.1em] space-y-2">
      ...
      {/* Clean Minimalist Footer - Flowing Seamless Transition */}
      <footer className="relative z-10 w-full py-16 md:py-24 px-6 md:px-12 flex flex-col items-center text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.2em] text-[#8c674b] hover:text-[#231916] transition-colors opacity-80 hover:opacity-100"
        >
          <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
          </svg>
